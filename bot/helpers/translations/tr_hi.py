...
"""
    ...
    RCLONE_MOUNT = '🔗 रिमोट माउंट करें'
    RCLONE_UNMOUNT = '❌ अनमाउंट करें'
    RCLONE_PICK_MOUNT = 'माउंट करने के लिए रिमोट चुनें'
    RCLONE_MOUNT_DONE = '✅ यहाँ माउंट किया गया: {}'
    RCLONE_MOUNT_FAIL = '❌ माउंट विफल: {}'
    RCLONE_UNMOUNT_PICK = 'अनमाउंट करने के लिए माउंट चुनें'
    RCLONE_UNMOUNT_DONE = '✅ अनमाउंट किया गया: {}'
    RCLONE_UNMOUNT_FAIL = '❌ अनमाउंट विफल: {}'
    RCLONE_NO_MOUNTS = 'कोई माउंट नहीं मिला.'
    RCLONE_DELETE_CONF = '🗑️ rclone.conf हटाएं'
    RCLONE_CONF_DELETED = '🗑️ rclone.conf हटाया गया.'
    RCLONE_CONF_DELETE_FAILED = 'rclone.conf हटाने में विफल'
